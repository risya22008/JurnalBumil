...
export default function DataIbuCard({ ibu }) {
    return (
        <div className='
            bg-white rounded-2xl py-4 md:py-8 px-6 md:px-10
            flex flex-wrap md:flex-nowrap 
            text-xs sm:text-sm sm:text-base md:text-lg lg:text-xl
            text-base md:text-lg lg:text-xl xl:text-2xl 
            gap-6 md:gap-9
            w-full
        '>
            <div className="w-14 sm:w-20 md:w-24 aspect-square flex-shrink-0">
            ...
            <div className="flex-1 text-[#02467C] min-w-0">
                <div className='
                    ...
                    gap-2 md:gap-4 text-start text-xs sm:text-sm md:text-base lg:text-lg
                '>
                    ...
                    <p className="col-span-2 text-black mb-4 md:mb-10 lg:mb-12 break-words text-justify leading-relaxed">
                ...
                <div className='flex flex-col md:flex-row gap-4 md:gap-9 mt-2 md:mt-6'>
                    <Link to={`/history-catatan/${ibu.id}`} className='w-full md:w-auto'>
                        <button className='
                           text-xs sm:text-sm sm:text-base md:text-lg lg:text-xl bg-[#02467C] text-white py-2 px-4 sm:py-3 sm:px-6 md:py-4 md:px-7 rounded-2xl hover:bg-[#0368B5] hover:shadow-lg w-full
                        '>
                            History Catatan
                        </button>
                    </Link>
